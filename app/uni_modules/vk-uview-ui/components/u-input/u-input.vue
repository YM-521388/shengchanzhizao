<template>
	<view class="u-input" :class="{
		...
		<textarea v-if="type == 'textarea'" class="u-input__input u-input__textarea" :style="[getStyle]"
			...
			:show-confirm-bar="showConfirmbar" :adjust-position="adjustPosition" @input="handleInput" @blur="handleBlur"
		...
		<input v-else class="u-input__input" :type="type == 'password' ? 'text' : type" :style="[getStyle]"
			...
			:selection-start="uSelectionStart" :show-confirm-bar="showConfirmbar" :adjust-position="adjustPosition"
