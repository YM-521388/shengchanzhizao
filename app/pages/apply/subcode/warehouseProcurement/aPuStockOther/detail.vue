  ...
  "unrealMaskLength": 1
			...
			<view class="u-p-l-20 u-p-r-20 form-item-box">
				<u-form-item label='收货人' prop="F_StockInUserId"  :label-width="100 * 1.5">
					<view class="jnpf-detail-text">{{dataForm.F_StockInUserId}}</view>
				</u-form-item>
			</view>
			<view class="u-p-l-20 u-p-r-20 form-item-box">
            ...
            <view class="jnpf-table" >
				<view class="jnpf-table-item" v-for="(item,i) in dataForm.tableFieldecf5cb" :key="i">
					<view class="jnpf-table-item-title u-flex u-row-between">
						<view class="jnpf-table-item-title-num u-line-1 u-p-r-20 u-p-l-20" @click="clickIcon('入库商品列表','')">{{'入库商品列表'}}({{i+1}})
						</view>
                    </view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='商品' prop="F_CustomerId"  :label-width="100 * 1.5">
							<view class="jnpf-detail-text">{{dataForm.tableFieldecf5cb[i].F_CustomerId}}</view>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='数量' prop="F_NumInfo"  :label-width="100 * 1.5">
							<JnpfInput v-model="dataForm.tableFieldecf5cb[i].F_NumInfo" :precision='0'  detailed disabled/>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='成本单价(元)' prop="F_Price"  :label-width="100 * 1.5">
							<JnpfInputNumber v-model="dataForm.tableFieldecf5cb[i].F_Price"  detailed disabled/>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='销售单价(元)' prop="F_Sales_Price"  :label-width="100 * 1.5">
							<JnpfInputNumber v-model="dataForm.tableFieldecf5cb[i].F_Sales_Price"  detailed disabled/>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='备注' prop="F_Description"  :label-width="100 * 1.5">
							<view class="jnpf-detail-text">{{dataForm.tableFieldecf5cb[i].F_Description}}</view>
						</u-form-item>
					</view>
                </view>
            </view>
            <view class="jnpf-table" >
				<view class="jnpf-table-item" v-for="(item,i) in dataForm.tableFielde1e6d9" :key="i">
					<view class="jnpf-table-item-title u-flex u-row-between">
					...
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='时间'prop="F_CreatorTime"  :label-width="100 * 1.5">
							<view class="jnpf-detail-text">{{dataForm.tableFielde1e6d9[i].F_CreatorTime}}</view>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='人员'prop="F_CreatorUserId"  :label-width="100 * 1.5">
							<view class="jnpf-detail-text">{{dataForm.tableFielde1e6d9[i].F_CreatorUserId}}</view>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='标题'prop="F_Title"  :label-width="100 * 1.5">
							<view class="jnpf-detail-text">{{dataForm.tableFielde1e6d9[i].F_Title}}</view>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='内容'prop="F_Content"  :label-width="100 * 1.5">
							<view class="jnpf-detail-text">{{dataForm.tableFielde1e6d9[i].F_Content}}</view>
						</u-form-item>
					</view>
                </view>
            </view>
    ...
    export default {
        ...
        methods: {
            ...
            initData() {
                ...
                if (this.dataForm.id) {
                    request({
                        url: '/api/example/APuStockOther/Detail/' + this.dataForm.id,
                        method: 'get',
                    }).then(res => {
