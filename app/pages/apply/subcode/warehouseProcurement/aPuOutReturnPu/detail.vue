		...
		<u-form :model="dataForm" ref="dataForm" :errorType="['toast']" label-position="left" :label-width="100 * 1.5" label-align="right" class="jnpf-form">
			<view class="u-p-l-20 u-p-r-20 form-item-box">
				<u-form-item label='采购退货单号' prop="F_ReturnOutNo"  :label-width="100 * 1.5">
					<JnpfInput v-model="dataForm.F_ReturnOutNo" detailed  :maskConfig='{
  "filler": "*",
  "maskType": 1,
  "prefixType": 1,
  "prefixLimit": 0,
  ...
  "unrealMaskLength": 1
			...
			<view class="u-p-l-20 u-p-r-20 form-item-box">
				<u-form-item label='出库类型' prop="F_ReturnOutType"  :label-width="100 * 1.5">
					<view class="jnpf-detail-text">{{dataForm.F_ReturnOutType}}</view>
				</u-form-item>
			</view>
			<view class="u-p-l-20 u-p-r-20 form-item-box">
				<u-form-item label='采购单号' prop="F_OrderId"  :label-width="100 * 1.5" class="popup-select">
			...
			<view class="u-p-l-20 u-p-r-20 form-item-box">
				<u-form-item label='退货日期' prop="F_ReturnOutDate"  :label-width="100 * 1.5">
					<view class="jnpf-detail-text">{{dataForm.F_ReturnOutDate}}</view>
				</u-form-item>
			</view>
			<view class="u-p-l-20 u-p-r-20 form-item-box">
				...
				<view class="jnpf-table-item" v-for="(item,i) in dataForm.tableFieldf5c8ef" :key="i">
					...
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='商品'prop="F_CustomerId"  :label-width="100 * 1.5">
							<view class="jnpf-detail-text">{{dataForm.tableFieldf5c8ef[i].F_CustomerId}}</view>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='退货数量'prop="F_NumInfo"  :label-width="100 * 1.5">
							<JnpfInput v-model="dataForm.tableFieldf5c8ef[i].F_NumInfo" disabled/>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='成本单价(元)'prop="F_Price"  :label-width="100 * 1.5">
							<JnpfInputNumber v-model="dataForm.tableFieldf5c8ef[i].F_Price"  detailed disabled/>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='备注'prop="F_Description"  :label-width="100 * 1.5">
							<view class="jnpf-detail-text">{{dataForm.tableFieldf5c8ef[i].F_Description}}</view>
						</u-form-item>
					</view>
                </view>
            </view>
            <view class="jnpf-table" >
				<view class="jnpf-table-item" v-for="(item,i) in dataForm.tableField3ff267" :key="i">
					<view class="jnpf-table-item-title u-flex u-row-between">
					...
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='时间'prop="F_CreatorTime"  :label-width="100 * 1.5">
							<view class="jnpf-detail-text">{{dataForm.tableField3ff267[i].F_CreatorTime}}</view>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='人员'prop="F_CreatorUserId"  :label-width="100 * 1.5">
							<view class="jnpf-detail-text">{{dataForm.tableField3ff267[i].F_CreatorUserId}}</view>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='标题'prop="F_Title"  :label-width="100 * 1.5">
							<view class="jnpf-detail-text">{{dataForm.tableField3ff267[i].F_Title}}</view>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='内容'prop="F_Content"  :label-width="100 * 1.5">
							<view class="jnpf-detail-text">{{dataForm.tableField3ff267[i].F_Content}}</view>
						</u-form-item>
					</view>
                </view>
            </view>
        ...
        methods: {
			...
			getF_OrderIdExtraInfo() {
				...
				const query = {
					...
					propsValue:'F_Id' ,
					relationField:'OrderNo' ,
					paramList,
				};
				getDataInterfaceDataInfoByIds('2013490232657317888 ', query).then(res => {
            ...
            initData() {
                ...
                if (this.dataForm.id) {
                    request({
                        url: '/api/example/APuOutReturnPu/Detail/' + this.dataForm.id,
                        method: 'get',
                    }).then(res => {
