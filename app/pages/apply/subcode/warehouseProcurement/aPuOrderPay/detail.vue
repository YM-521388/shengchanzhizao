...
<template>
		...
		<u-form :model="dataForm" ref="dataForm" :errorType="['toast']" label-position="left" :label-width="100 * 1.5" label-align="right" class="jnpf-form">
			<view class="u-p-l-20 u-p-r-20 form-item-box">
				<u-form-item label='采购单' prop="F_OrderId"  :label-width="100 * 1.5">
					<JnpfInput v-model="dataForm.F_OrderId" detailed  :maskConfig='{
  "filler": "*",
  "maskType": 1,
  "prefixType": 1,
  "prefixLimit": 0,
  ...
  "unrealMaskLength": 1
			...
			<view class="u-p-l-20 u-p-r-20 form-item-box">
				<u-form-item label='付款金额' prop="F_Money"  :label-width="100 * 1.5">
					<JnpfInputNumber v-model="dataForm.F_Money"  detailed disabled/>
				</u-form-item>
			</view>
			<view class="u-p-l-20 u-p-r-20 form-item-box">
				<u-form-item label='付款日期' prop="F_PayDate"  :label-width="100 * 1.5">
					<view class="jnpf-detail-text">{{dataForm.F_PayDate}}</view>
				</u-form-item>
			</view>
			<view class="u-p-l-20 u-p-r-20 form-item-box">
    ...
    export default {
        ...
        methods: {
            ...
            initData() {
                ...
                if (this.dataForm.id) {
                    request({
                        url: '/api/example/APuOrderPay/Detail/' + this.dataForm.id,
                        method: 'get',
                    }).then(res => {
