		...
		<u-form :model="dataForm" ref="dataForm" :errorType="['toast']" label-position="left" :label-width="100 * 1.5" label-align="right" class="jnpf-form">
			<view class="u-p-l-20 u-p-r-20 form-item-box">
				<u-form-item label='合同编号' prop="F_ContractCode"  :label-width="100 * 1.5">
					<JnpfInput v-model="dataForm.F_ContractCode" detailed  :maskConfig='{
  "filler": "*",
  "maskType": 1,
  "prefixType": 1,
  "prefixLimit": 0,
...
<!-- 			<view class="u-p-l-20 u-p-r-20 form-item-box">
				<u-form-item label='客户地址' prop="F_AddressId"  :label-width="100 * 1.5">
					<view class="jnpf-detail-text">{{dataForm.F_AddressId}}</view>
				</u-form-item>
			</view> -->
			<view class="u-p-l-20 u-p-r-20 form-item-box">
				<u-form-item label='预付款' prop="F_PrepayAmount"  :label-width="100 * 1.5">
					<JnpfInputNumber v-model="dataForm.F_PrepayAmount"  detailed disabled/>
				</u-form-item>
			</view>
			<view class="u-p-l-20 u-p-r-20 form-item-box">
				<u-form-item label='销售总数' prop="F_SaleTotal"  :label-width="100 * 1.5">
					<JnpfInputNumber v-model="dataForm.F_SaleTotal" :precision='0'  detailed disabled/>
				</u-form-item>
			</view>
			<view class="u-p-l-20 u-p-r-20 form-item-box">
				<u-form-item label='合同金额' prop="F_ContractAmount"  :label-width="100 * 1.5">
					<JnpfInputNumber v-model="dataForm.F_ContractAmount"  detailed disabled/>
				</u-form-item>
			</view>
			<view class="u-p-l-20 u-p-r-20 form-item-box">
				<u-form-item label='交货日期' prop="F_DeliveryDate"  :label-width="100 * 1.5">
					<view class="jnpf-detail-text">{{dataForm.F_DeliveryDate}}</view>
				</u-form-item>
			</view>
			<view class="u-p-l-20 u-p-r-20 form-item-box">
				<u-form-item label='业务员' prop="F_SalesmanId"  :label-width="100 * 1.5">
					<view class="jnpf-detail-text">{{dataForm.F_SalesmanId}}</view>
				</u-form-item>
			</view>
			<view class="u-p-l-20 u-p-r-20 form-item-box">
				<u-form-item label='是否含税' prop="F_IsTaxable"  :label-width="100 * 1.5">
					<view class="jnpf-detail-text">{{dataForm.F_IsTaxable}}</view>
				</u-form-item>
			</view>
			<view class="u-p-l-20 u-p-r-20 form-item-box">
            ...
            <view class="jnpf-table" >
				<view class="jnpf-table-item" v-for="(item,i) in dataForm.tableFieldf4dfaf" :key="i">
					<view class="jnpf-table-item-title u-flex u-row-between">
						<view class="jnpf-table-item-title-num u-line-1 u-p-r-20 u-p-l-20" @click="clickIcon('选择合同商品','')">{{'选择合同商品'}}({{i+1}})
						</view>
                    </view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='商品'prop="F_CustomerId"  :label-width="100 * 1.5">
							<view class="jnpf-detail-text">{{dataForm.tableFieldf4dfaf[i].F_CustomerId}}</view>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='单价'prop="F_Price"  :label-width="100 * 1.5">
							<JnpfInputNumber v-model="dataForm.tableFieldf4dfaf[i].F_Price"  detailed disabled/>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='销售数量'prop="F_SaleQty"  :label-width="100 * 1.5">
							<JnpfInputNumber v-model="dataForm.tableFieldf4dfaf[i].F_SaleQty" :precision='0'  detailed disabled/>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='折扣'prop="F_Discount"  :label-width="100 * 1.5">
							<JnpfInputNumber v-model="dataForm.tableFieldf4dfaf[i].F_Discount"  detailed disabled/>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='商品备注'prop="F_Description"  :label-width="100 * 1.5">
							<view class="jnpf-detail-text">{{dataForm.tableFieldf4dfaf[i].F_Description}}</view>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='门板厚度'prop="F_DoorPlateThickness"  :label-width="100 * 1.5">
							<JnpfInputNumber v-model="dataForm.tableFieldf4dfaf[i].F_DoorPlateThickness"  detailed disabled/>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='箱体板厚'prop="F_BoxPlateThickness"  :label-width="100 * 1.5">
							<JnpfInputNumber v-model="dataForm.tableFieldf4dfaf[i].F_BoxPlateThickness"  detailed disabled/>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='安装或安装梁'prop="F_InstallOrBeam"  :label-width="100 * 1.5">
							<JnpfInputNumber v-model="dataForm.tableFieldf4dfaf[i].F_InstallOrBeam"  detailed disabled/>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='锁具'prop="F_LockSet"  :label-width="100 * 1.5">
							<view class="jnpf-detail-text">{{dataForm.tableFieldf4dfaf[i].F_LockSet}}</view>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='铰链'prop="F_Hinge"  :label-width="100 * 1.5">
							<view class="jnpf-detail-text">{{dataForm.tableFieldf4dfaf[i].F_Hinge}}</view>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='颜色'prop="F_Color"  :label-width="100 * 1.5">
							<view class="jnpf-detail-text">{{dataForm.tableFieldf4dfaf[i].F_Color}}</view>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='材质'prop="F_Material"  :label-width="100 * 1.5">
							<view class="jnpf-detail-text">{{dataForm.tableFieldf4dfaf[i].F_Material}}</view>
						</u-form-item>
					</view>
					<view class="u-p-l-20 u-p-r-20 form-item-box">
						<u-form-item label='附件'prop="F_Files"  :label-width="100 * 1.5">
							<JnpfUploadFile v-model="dataForm.tableFieldf4dfaf[i].F_Files" :noShowBtn="false" :limit='9' sizeUnit='MB' :fileSize='10'  detailed/>
						</u-form-item>
					</view>
                </view>
            </view>
