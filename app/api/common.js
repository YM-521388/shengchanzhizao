...
//通过库存编码获取商品
export function getDataInterGoodsInventoryNo(id, data) {
	return request({
		url: `/api/system/DataInterface/${id}/Actions/Preview`,
		method: 'post',
		data: data
...
// 根据BOM获取用料清单
export function getBOMGoodsList(id) {
	return request({
		url: `/api/example/ABom/BOMGoodsList/${id}`,
		method: 'post',
		options: {
			load: false
		}
...
// 根据工艺路线获取工序列表
export function getRoutingStepList(id) {
	return request({
		url: `/api/example/AProdRoutingStep/RoutingStepList/${id}`,
		method: 'post',
		options: {
			load: false
		}
...
// 获取生产人员、质检人员列表
export function getUserCon(id) {
	return request({
		url: `/api/example/AProdTask/UserCon/${id}`,
		method: 'post',
		options: {
			load: false
		}
...
export function getContractItemsByContractId(id) {
	return request({
		url: `/api/example/APuReturnSo/GetContractItemsByContractId/${id}`,
		method: 'GET'
	})
}
...
export function getContractRelationById(id) {
	return request({
		url: `/api/example/APuReturnSo/GetContractRelationById/${id}`,
		method: 'GET'
	})
}
// 根据加工单和仓库获取用料清单加工
export function GetProcessingGoodsList(id, warehouseId) {
  return request({
  	url: `/api/example/AProdProcess/ProcessingGoodsList/${id}/${warehouseId}`,
  	method: 'post'
  })
}
// 根据加工单和仓库获取用料清单外协
export function GetOutsourceGoodsList(id, warehouseId) {
  return request({
  	url: `/api/example/AProdOutsource/OutsourceGoodsList/${id}/${warehouseId}`,
  	method: 'post'
  })
}
// 根据采购单 id 获取订单子项（F_CustomerId, F_Num）
export function getOrderItems(orderId) {
  return request({
  	url: `/api/example/APuOutReturnPu/OrderItems/${orderId}`,
  	method: 'get'
  })
}
// 根据生产计划ID获取物料与数量
export function getProdPlanItems(prodPlanId) {
  return request({
  	url: `/api/example/APuOrder/ProdPlanItems/${prodPlanId}`,
  	method: 'get'
  })
}
// 通过商品获取单位
