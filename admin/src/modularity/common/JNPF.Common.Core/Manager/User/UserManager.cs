...
public class UserManager : IUserManager, IScoped
{
    ...
    public List<string> CurrentOrganizationAndSubOrganizations
    {
        get
        {
            if (_currentOrganizationAndSubOrganizations == null)
            {
                ...
                _currentOrganizationAndSubOrganizations = _currentOrganizationAndSubOrganizations.Distinct().ToList();
            }
    ...
    public List<string> CommonModuleEnCodeList
    {
        get
        {
            var list = new List<string> { "workFlow.addFlow", "workFlow.flowLaunch", "workFlow.entrust", "workFlow", "workFlow.flowTodo", "workFlow.flowDone", "workFlow.flowCirculate", "workFlow.flowToSign", "workFlow.flowDoing", "workFlow.schedule","workFlow.printTemplate" };
