...
/// a_prod_plan实体.
/// </summary>
[SugarTable("a_prod_plan")]
public class AProdPlanEntity : ITenantFilter
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 生产计划商品列表.
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(AProdPlanItemEntity.F_ProdPlanId), nameof(id))]
    public List<AProdPlanItemEntity> AProdPlanItemList { get; set; }
