...
/// 供应商管理2实体.
/// </summary>
[SugarTable("a_supplier")]
public class ASupplierEntity : ITenantFilter
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 供应商标签.
    /// </summary>
    [SugarColumn(ColumnName = "F_SupplierTags")]
    public string? F_SupplierTags { get; set; }

    /// <summary>
    /// 附件.
    /// </summary>
    [SugarColumn(ColumnName = "F_AttachmentUrls")]
    public string? F_AttachmentUrls { get; set; }
    ...
    /// 是否启用.
    /// </summary>
    [SugarColumn(ColumnName = "F_StartUsing")]
