...
/// a_pu_check实体.
/// </summary>
[SugarTable("a_pu_check")]
public class APuCheckEntity : ITenantFilter
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 盘库单号.
    /// </summary>
    [SugarColumn(ColumnName = "F_CheckNo")]
    ...
    /// 库存盘点商品列表.
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(APuCheckItemEntity.F_CheckId), nameof(id))]
    public List<APuCheckItemEntity> APuCheckItemList { get; set; }

    /// <summary>
    /// 库存盘点日志.
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(APuCheckLogEntity.F_CheckId), nameof(id))]
    public List<APuCheckLogEntity> APuCheckLogList { get; set; }
