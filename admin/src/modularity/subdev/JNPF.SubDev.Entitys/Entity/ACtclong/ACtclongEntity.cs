...
/// BOM日志实体.
/// </summary>
[SugarTable("a_ctc_log")]
public class ACtclongEntity : ITenantFilter
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 关联外键id.
    /// </summary>
    [SugarColumn(ColumnName = "F_Ctcid", IsPrimaryKey = true)]
    public string? F_Ctcid { get; set; }
