...
/// a_pu_stock_other实体.
/// </summary>
[SugarTable("a_pu_stock_other")]
public class APuStockOtherEntity : ITenantFilter
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 其他入库单商品列表.
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(APuStockOtherItemEntity.F_StockInOTId), nameof(id))]
    public List<APuStockOtherItemEntity> APuStockOtherItemList { get; set; }

    /// <summary>
    /// 其他入库单日志.
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(APuStockOtherLogEntity.F_StockInOTId), nameof(id))]
    public List<APuStockOtherLogEntity> APuStockOtherLogList { get; set; }
