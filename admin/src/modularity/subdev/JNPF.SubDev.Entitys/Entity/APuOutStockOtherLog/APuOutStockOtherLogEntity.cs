...
/// 设计子表实体.
/// </summary>
[SugarTable("a_pu_out_stock_other_log")]
public class APuOutStockOtherLogEntity : ITenantFilter
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 其他出库单号Id.
    /// </summary>
    [SugarColumn(ColumnName = "F_StockOutOTId")]
    public string? F_StockOutOTId { get; set; }
