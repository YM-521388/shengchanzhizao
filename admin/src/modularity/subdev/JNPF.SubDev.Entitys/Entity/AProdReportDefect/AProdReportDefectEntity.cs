...
/// 不良品项实体.
/// </summary>
[SugarTable("a_prod_report_defect")]
public class AProdReportDefectEntity : ITenantFilter
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 报工ID.
    /// </summary>
    [SugarColumn(ColumnName = "F_ReportId")]
    public string? F_ReportId { get; set; }

    /// <summary>
    /// 不良品项ID.
    /// </summary>
    [SugarColumn(ColumnName = "F_DefectId")]
