...
/// a_prod_routing实体.
/// </summary>
[SugarTable("a_prod_routing")]
public class AProdRoutingEntity : ITenantFilter
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 工艺路线编号.
    /// </summary>
    [SugarColumn(ColumnName = "F_RoutingNo")]
    public string? F_RoutingNo { get; set; }

    /// <summary>
    /// 工艺路线名称.
    /// </summary>
    [SugarColumn(ColumnName = "F_RoutingName")]
    ...
    /// 工艺路线工序信息.
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(AProdRoutingStepEntity.F_RoutingId), nameof(id))]
    public List<AProdRoutingStepEntity> AProdRoutingStepList { get; set; }
