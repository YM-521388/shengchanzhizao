...
/// 商品列表实体.
/// </summary>
[SugarTable("a_pu_out_stock_so_item")]
public class APuOutStockSoItemEntity : ITenantFilter
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 销售出库单ID.
    /// </summary>
    [SugarColumn(ColumnName = "F_StockOutSOId")]
    ...
    /// 销售单价(元).
    /// </summary>
    [SugarColumn(ColumnName = "F_SalesPrice")]
