...
/// <summary>
/// a_pu_out_stock_prod实体.
/// </summary>
[SugarTable("a_pu_out_stock_prod")]
public class APuOutStockProdEntity : ITenantFilter
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 生产出库单商品列表.
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(APuOutStockProdItemEntity.F_StockOutProdId), nameof(id))]
    public List<APuOutStockProdItemEntity> APuOutStockProdItemList { get; set; }

    /// <summary>
    /// 生产出库单号日志.
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(APuOutStockProdLogEntity.F_StockOutProdId), nameof(id))]
    public List<APuOutStockProdLogEntity> APuOutStockProdLogList { get; set; }
