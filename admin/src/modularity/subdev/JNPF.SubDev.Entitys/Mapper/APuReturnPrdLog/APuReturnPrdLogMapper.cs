...
namespace JNPF.example.Entitys.Mapper.APuReturnPrdLog;

public class Mapper : IRegister
{
	public void Register(TypeAdapterConfig config)
	{
		config.ForType<APuReturnPrdLogCrInput, APuReturnPrdLogEntity>()
		...
		;
		//config.ForType<APuReturnPrdLogEntity, APuReturnPrdLogListOutput>()
		;
		config.ForType<APuReturnPrdLogEntity, APuReturnPrdLogInfoOutput>()
			.Map(dest => dest.F_Type, src => src.F_Type != null ? src.F_Type : null)
			.Map(dest => dest.F_Title, src => src.F_Title != null ? src.F_Title : null)
			.Map(dest => dest.F_Content, src => src.F_Content != null ? src.F_Content : null)
			.Map(dest => dest.F_Reason, src => src.F_Reason != null ? src.F_Reason : null)
		...
		;
		config.ForType<APuReturnPrdLogEntity, APuReturnPrdLogDetailOutput>()
			.Map(dest => dest.F_Type, src => src.F_Type != null ? src.F_Type : null)
			.Map(dest => dest.F_Title, src => src.F_Title != null ? src.F_Title : null)
			.Map(dest => dest.F_Content, src => src.F_Content != null ? src.F_Content : null)
			.Map(dest => dest.F_Reason, src => src.F_Reason != null ? src.F_Reason : null)
