...
/// <summary>
/// a_pu_out_stock_prod详情输出参数.
/// </summary>
public class APuOutStockProdDetailOutput
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 生产出库单商品列表.
    /// </summary>
    public List<APuOutStockProdItemDetailOutput> tableField2752cf { get; set; }

    /// <summary>
    /// 生产出库单号日志.
    /// </summary>
    public List<APuOutStockProdLogDetailOutput> tableField49228c { get; set; }
