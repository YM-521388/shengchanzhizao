...
/// <summary>
/// a_pu_out_stock_prod修改输入参数.
/// </summary>
public class APuOutStockProdCrInput
{
    /// <summary>
    /// 生产出库单号.
    /// </summary>
    ...
    /// 生产出库单商品列表.
    /// </summary>
    public List<APuOutStockProdItemCrInput> tableField2752cf { get; set; }

    /// <summary>
    /// 生产出库单号日志.
    /// </summary>
    public List<APuOutStockProdLogCrInput> tableField49228c { get; set; }
