...
/// <summary>
/// a_pu_out_stock_other修改输入参数.
/// </summary>
public class APuOutStockOtherCrInput
{
    /// <summary>
    /// 其他出库单号.
    /// </summary>
    ...
    /// 其他出库单商品列表.
    /// </summary>
    public List<APuOutStockOtherItemCrInput> tableField44e07d { get; set; }

    /// <summary>
    /// 其他出库单号日志.
    /// </summary>
    public List<APuOutStockOtherLogCrInput> tableField211772 { get; set; }
