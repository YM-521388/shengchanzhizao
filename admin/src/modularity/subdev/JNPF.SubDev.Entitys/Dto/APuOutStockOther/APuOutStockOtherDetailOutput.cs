...
/// <summary>
/// a_pu_out_stock_other详情输出参数.
/// </summary>
public class APuOutStockOtherDetailOutput
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 其他出库单商品列表.
    /// </summary>
    public List<APuOutStockOtherItemDetailOutput> tableField44e07d { get; set; }

    /// <summary>
    /// 其他出库单号日志.
    /// </summary>
    public List<APuOutStockOtherLogDetailOutput> tableField211772 { get; set; }
