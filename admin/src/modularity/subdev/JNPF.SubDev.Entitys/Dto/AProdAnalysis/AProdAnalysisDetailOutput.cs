...
/// <summary>
/// a_prod_analysis详情输出参数.
/// </summary>
public class AProdAnalysisDetailOutput
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 分析时间.
    /// </summary>
    public string F_AnalysisTime { get; set; }
    ...
    /// 物料分析商品列表信息.
    /// </summary>
    public List<AProdAnalysisItemDetailOutput> tableField4d57ab { get; set; }
