...
/// <summary>
/// a_pu_stock_other输出参数.
/// </summary>
public class APuStockOtherInfoOutput
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 其他入库单商品列表.
    /// </summary>
    public List<APuStockOtherItemInfoOutput> tableFieldecf5cb { get; set; }

    /// <summary>
    /// 其他入库单日志.
    /// </summary>
    public List<APuStockOtherLogInfoOutput> tableFielde1e6d9 { get; set; }
