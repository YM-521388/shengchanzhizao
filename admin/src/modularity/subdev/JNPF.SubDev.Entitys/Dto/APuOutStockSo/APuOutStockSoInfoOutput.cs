...
/// <summary>
/// a_pu_out_stock_so输出参数.
/// </summary>
public class APuOutStockSoInfoOutput
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 销售出库商品列表.
    /// </summary>
    public List<APuOutStockSoItemInfoOutput> tableFielde48def { get; set; }

    /// <summary>
    /// 销售出库单日志.
    /// </summary>
    public List<APuOutStockSoLogInfoOutput> tableField67a4d7 { get; set; }
