...
/// <summary>
/// a_pu_out_return_pu输出参数.
/// </summary>
public class APuOutReturnPuInfoOutput
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 采购退货单商品列表.
    /// </summary>
    public List<APuOutReturnPuItemInfoOutput> tableFieldf5c8ef { get; set; }

    /// <summary>
    /// 采购退货单日志.
    /// </summary>
    public List<APuOutReturnPuLogInfoOutput> tableField3ff267 { get; set; }
