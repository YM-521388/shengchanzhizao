...
/// a_pu_return_prd输出参数.
/// </summary>
public class APuReturnPrdInfoOutput
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 生产退料单商品列表.
    /// </summary>
    public List<APuReturnPrdItemInfoOutput> tableFieldbb1084 { get; set; }

    /// <summary>
    /// 生产退料单日志.
    /// </summary>
    public List<APuReturnPrdLogInfoOutput> tableFieldceb7bd { get; set; }
