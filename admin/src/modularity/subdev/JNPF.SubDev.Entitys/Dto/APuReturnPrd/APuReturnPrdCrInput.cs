...
/// <summary>
/// a_pu_return_prd修改输入参数.
/// </summary>
public class APuReturnPrdCrInput
{
    /// <summary>
    /// 生产退料单号.
    /// </summary>
    ...
    /// 生产退料单商品列表.
    /// </summary>
    public List<APuReturnPrdItemCrInput> tableFieldbb1084 { get; set; }

    /// <summary>
    /// 生产退料单日志.
    /// </summary>
    public List<APuReturnPrdLogCrInput> tableFieldceb7bd { get; set; }
