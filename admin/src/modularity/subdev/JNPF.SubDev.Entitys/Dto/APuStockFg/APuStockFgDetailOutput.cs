...
/// a_pu_stock_fg详情输出参数.
/// </summary>
public class APuStockFgDetailOutput
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 成品入库单商品列表.
    /// </summary>
    public List<APuStockFgItemDetailOutput> tableFieldc43f9b { get; set; }

    /// <summary>
    /// 成品入库单日志.
    /// </summary>
    public List<APuStockFgLogDetailOutput> tableFieldfcaa70 { get; set; }
