...
/// <summary>
/// a_prod_processing修改输入参数.
/// </summary>
public class AProdProcessingCrInput
{
    /// <summary>
    /// 合同ID.
    /// </summary>
    ...
    /// 加工单用料清单.
    /// </summary>
    public List<AProdBomItemCrInput> tableField449e6c { get; set; }

    /// <summary>
    /// 生产任务.
    /// </summary>
    public List<AProdTaskCrInput> tableField0c720e { get; set; }
