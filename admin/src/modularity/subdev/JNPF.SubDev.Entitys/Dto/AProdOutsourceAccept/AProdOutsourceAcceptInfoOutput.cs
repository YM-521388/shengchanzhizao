...
/// <summary>
/// a_prod_outsource_accept输出参数.
/// </summary>
public class AProdOutsourceAcceptInfoOutput
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 外协验收内容.
    /// </summary>
    public List<AProdOutsourceAcceptItemInfoOutput> tableField561a64 { get; set; }

    /// <summary>
    /// 外协结算日志.
    /// </summary>
    public List<AProdOutsourceSettleLogInfoOutput> tableField4b440e { get; set; }
