...
/// 商品输出参数.
/// </summary>
public class AProdProjectItemInfoOutput
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 项目商品工序列表.
    /// </summary>
    public List<AProdProjectStepListOutput> Process { get; set; }

    /// <summary>
    /// 项目商品用料清单.
    /// </summary>
    public List<AProdProjectGoodListOutput> ProjectGoods { get; set; }
