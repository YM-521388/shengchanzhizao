...
/// a_pu_stock_pu列表查询输入.
/// </summary>
public class APuStockPuListQueryInput : PageInputBase
{
    /// <summary>
    /// 高级查询.
    /// </summary>
    ...
    /// 入库仓库ID.
    /// </summary>
    //public object F_WarehouseId { get; set; }
    ...
    /// 采购单id.
    /// </summary>
    public object F_pu_Orderld { get; set; }

    /// <summary>
    /// 收货人.
    /// </summary>
    public object F_StockInUserId { get; set; }
