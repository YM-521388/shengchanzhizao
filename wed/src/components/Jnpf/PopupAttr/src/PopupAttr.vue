...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'JnpfPopupAttr', inheritAttrs: false });
  ...
  const getBindValue = computed(() => ({
    ...
    placeholder: props.isStorage ? t('component.jnpf.popupAttr.storage') : t('component.jnpf.popupAttr.unStorage'),
  }));
