...
<script lang="ts" setup>
  ...
  import { popupMultipleSelectProps } from './props';
  ...
  defineOptions({ name: 'JnpfPopupMultipleSelect', inheritAttrs: false });
  const props = defineProps(popupMultipleSelectProps);
