...
export class JnpfSheetsCellEchartPlugin extends Plugin {
  static override pluginName = 'JNPF_SHEET_CELL_ECHART_PLUGIN';
  ...
  override onStarting(): void {
    ([[JnpfSheetsCellEchartService]] as Dependency[]).forEach(d => this._injector.add(d));
  }
}
