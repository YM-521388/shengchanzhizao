import { templateJson1, templateJson2, templateJson3, templateJson4, templateJson5, templateJson6, templateJson7, templateJson8 } from '../template';
...
export const verticalAlignList = [
  {
    type: 'left',
    title: '左对齐',
...
export const horizontalAlignList = [
  {
    type: 'top',
    title: '顶部对齐',
