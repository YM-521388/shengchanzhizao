...
<script lang="ts" setup>
  ...
  const { activeStep, fileName, fileList, btnLoading, list, result, resultList, columns, resultColumns, skipPreview, recordId } = toRefs(state);
  ...
  function handleSubmit() {
    ...
    if (state.recordId) query.recordId = state.recordId;
