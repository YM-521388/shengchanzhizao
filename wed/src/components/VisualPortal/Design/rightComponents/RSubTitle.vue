<template>
  <a-collapse-panel>
    ...
    <a-form-item label="副标题名称">
      <jnpf-i18n-input v-model:value="activeData.option.titleSubtext" v-model:i18n="activeData.option.titleSubtextI18nCode" placeholder="请输入" />
    </a-form-item>
    ...
    <a-form-item label="字体颜色">
      <jnpf-color-picker v-model:value="activeData.option.titleSubtextStyleColor" size="small" />
    </a-form-item>
  </a-collapse-panel>
</template>
