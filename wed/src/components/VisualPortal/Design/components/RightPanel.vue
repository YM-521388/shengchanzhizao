      ...
      <ScrollContainer class="p-15px !pt-0px">
        <a-form :colon="false" layout="vertical" v-if="activeKey === 1 && activeData && activeData.jnpfKey">
          <a-collapse v-model:activeKey="activeName" accordion ghost expandIconPosition="end">
            ...
            <Jump :key="19" :activeData="activeData" :showType="showType" v-if="needJumpSetList.includes(activeData.jnpfKey)" />
            ...
            <CustomEcharts :key="18" :activeData="activeData" :showType="showType" v-if="activeData.jnpfKey == 'customEcharts'" />
          </a-collapse>
