...
const { approver, processing, subFlow, connect, event, timeout, notice, webhook } = jnpfConfigBpmnContextPad;
...
const jnpfStartConfig: any = {
  ...
  contextPad: {
    ...
    customization: { approver, processing, subFlow, connect }, // 自定义 只有default = false 开启
