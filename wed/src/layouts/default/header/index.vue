  ...
  <Header :class="getHeaderClass">
    ...
    <div :class="`${prefixCls}-action`">
      ...
      <!-- <a-tooltip title="AI助手">
        <div :class="`${prefixCls}-action__item`" @click="handleOpenAIModal">
          <i class="icon-ym icon-ym-ai"></i>
        </div>
      </a-tooltip> -->
      ...
      <AIChatModal ref="AIModalRef" />
    </div>
  </Header>
</template>
<script lang="ts">
  import { defineComponent, unref, computed, reactive, toRefs, onMounted, ref } from 'vue';
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      function handleOpenAIModal() {
        (unref(AIModalRef) as any)?.openModal();
      }
