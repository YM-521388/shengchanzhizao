<template>
  <BasicPopup v-bind="$attrs" @register="registerPopup" :title="title" class="full-popup">
    <template v-if="groupList.length">
      <a-tabs v-model:activeKey="activeKey" tab-position="left" class="common-left-tabs permission-contain" destroyInactiveTabPane>
...
<script lang="ts" setup>
  ...
  const permissionList = [
    ...
    { fullName: '流程权限', id: 'flow' },
    { fullName: '打印模板权限', id: 'print' },
  ];
