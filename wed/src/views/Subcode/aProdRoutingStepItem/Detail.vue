<template>
  <BasicModal v-bind="$attrs" @register="registerModal" :title="title" width="1000px" :minHeight="100" :showOkBtn="false">
        ...
        <a-row :gutter="15">
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_StepId" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfInput v-model:value="dataForm.F_StepId" :maskConfig='{
  "filler": "*",
  "maskType": 1,
  "prefixType": 1,
  "prefixLimit": 0,
  ...
  "unrealMaskLength": 1
          ...
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_GoodsId" :labelCol="{ style: { width: '100px' } }">
	          ...
	          <ExtraRelationInfo :extraOptions="state.extraOptions.F_GoodsId" :data="state.extraData.F_GoodsId" v-if="state.extraOptions.F_GoodsId?.length && state.extraData.F_GoodsId && JSON.stringify(state.extraData.F_GoodsId) !== '{}'" />
            </a-form-item>
          </a-col>
          <a-col :span="24" class="ant-col-item" >
