      ...
      <a-form :colon="false" layout="horizontal" labelAlign="right"  :labelCol="{ style: { width: '100px' } }" :model="dataForm" :rules="dataRule" ref="formRef">
        <a-row :gutter="15">
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_StepId" :labelCol="{ style: { width: '100px' } }">
              <template #label>工艺ID</template>
              <JnpfInput v-model:value="dataForm.F_StepId" placeholder='请输入' allowClear :style='{
  "width": "100%"
}'  :showCount='false'  />
            </a-form-item>
          </a-col>
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_GoodsId" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfPopupSelect v-model:value="dataForm.F_GoodsId" placeholder='请选择' :templateJson="optionsObj.F_GoodsIdTemplateJson" allowClear field="F_GoodsId" interfaceId="2012085692393459712" :columnOptions="optionsObj.F_GoodsIdOptions" relationField="F_GoodsName" propsValue="F_Id" :pageSize="20" popupType="dialog" popupTitle="选择数据" popupWidth="1000px" hasPage :style='{
  "width": "100%"
