<template>
  <BasicModal v-bind="$attrs" @register="registerModal" :title="title" width="1300px" :minHeight="100" :showOkBtn="false">
...
<script lang="ts" setup>
  ...
  const columnsGood: BasicColumn[] = [
    ...
    { title: '单位用量', dataIndex: 'F_Unit', resizable: true, width: 100 },
