      ...
      <a-form :colon="false" layout="horizontal" labelAlign="right"  :labelCol="{ style: { width: '100px' } }" :model="dataForm" :rules="dataRule" ref="formRef">
        <a-row :gutter="15">
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_ProcessingId" :labelCol="{ style: { width: '100px' } }">
              <template #label>加工单</template>
              <JnpfSelect v-model:value="dataForm.F_ProcessingId" placeholder='请选择' :options="optionsObj.F_ProcessingIdOptions" :fieldNames="optionsObj.F_ProcessingIdProps" allowClear showSearch :style='{
  "width": "100%"
}'  />
            </a-form-item>
          </a-col>
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_Title" :labelCol="{ style: { width: '100px' } }">
              <template #label>标题</template>
              <JnpfInput v-model:value="dataForm.F_Title" placeholder='请输入' allowClear :style='{
  "width": "100%"
}'  :showCount='false'  />
            </a-form-item>
          </a-col>
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_Content" :labelCol="{ style: { width: '100px' } }">
              <template #label>内容</template>
              <JnpfTextarea v-model:value="dataForm.F_Content" placeholder='请输入' allowClear :autoSize='{
  "minRows": 2,
  "maxRows": 2
}' :style='{
  "width": "100%"
          ...
          <a-col :span="24" class="ant-col-item" v-show="false" >
            <a-form-item name="F_CreatorUserId" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfOpenData v-model:value="dataForm.F_CreatorUserId" type="currUser" readonly :style='{
  "width": "100%"
}'  />
            </a-form-item>
          </a-col>
