      ...
      <a-form :colon="false" layout="horizontal" labelAlign="right"  :labelCol="{ style: { width: '100px' } }" :model="dataForm" :rules="dataRule" ref="formRef">
        <a-row :gutter="15">
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_RepairId" :labelCol="{ style: { width: '100px' } }">
              <template #label>维修工单</template>
              <JnpfInput v-model:value="dataForm.F_RepairId" placeholder='请输入' allowClear :style='{
  "width": "100%"
}'  :showCount='false'  />
            </a-form-item>
          </a-col>
  ...
  "width": "100%"
          ...
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_Content" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfInput v-model:value="dataForm.F_Content" placeholder='请输入' allowClear :style='{
  "width": "100%"
}'  :showCount='false'  />
            </a-form-item>
          </a-col>
