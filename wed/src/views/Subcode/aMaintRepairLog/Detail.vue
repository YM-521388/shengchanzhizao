        ...
        <a-row :gutter="15">
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_RepairId" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfInput v-model:value="dataForm.F_RepairId" :maskConfig='{
  "filler": "*",
  "maskType": 1,
  "prefixType": 1,
  "prefixLimit": 0,
  ...
  "unrealMaskLength": 1
          ...
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_Title" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfInput v-model:value="dataForm.F_Title" :maskConfig='{
  "filler": "*",
  "maskType": 1,
  "prefixType": 1,
  "prefixLimit": 0,
  ...
  "unrealMaskLength": 1
          ...
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_Content" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfInput v-model:value="dataForm.F_Content" :maskConfig='{
  "filler": "*",
  "maskType": 1,
  "prefixType": 1,
  "prefixLimit": 0,
