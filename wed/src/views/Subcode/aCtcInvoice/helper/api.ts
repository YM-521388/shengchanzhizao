...
enum Api {
  Prefix = '/api/example/ACtcInvoice',
}
...
// 计算合同金额
export function calculateContractAmount(F_ContractId) {
  return defHttp.get({ url: Api.Prefix + `/CalculateContractAmount/${F_ContractId}` });
}
