  ...
  <BasicModal
    ...
    <a-row class="dynamic-form">
      <a-form :colon="false" layout="horizontal" labelAlign="right" :labelCol="{ style: { width: '100px' } }" :model="dataForm" :rules="dataRule" ref="formRef">
        <a-row :gutter="15">
          <a-col :span="24" class="ant-col-item" v-if="hasFormP('F_ParentId')">
          ...
          <a-col :span="24" class="ant-col-item" v-if="hasFormP('F_Code')">
            <a-form-item name="F_Code" :labelCol="{ style: { width: '100px' } }">
              <template #label>分类编号</template>
              <JnpfInput
                v-model:value="dataForm.F_Code"
                placeholder="请输入"
                allowClear
          ...
          <a-col :span="24" class="ant-col-item" v-if="hasFormP('F_SortCode')">
            <a-form-item name="F_SortCode" :labelCol="{ style: { width: '100px' } }">
              <template #label>排序</template>
              <JnpfInputNumber
                v-model:value="dataForm.F_SortCode"
                placeholder="请输入"
                :controls="false"
                :style="{
                  width: '100%',
...
<script lang="ts" setup>
  ...
  const state = reactive<State>({
    ...
    optionsObj: {
      F_ParentIdProps: { label: 'F_Name', value: 'F_Id' },
    },
    currVmodel: '',
    currTableConf: {},
    tableRows: {},
  ...
  function getF_ParentIdOptions() {
    ...
    getDataInterfaceRes('2008421268986138624', query).then(res => {
      let data = res.data;
