  ...
  "width": "100%"
          ...
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_Region" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfAreaSelect v-model:value="dataForm.F_Region" placeholder='请选择' allowClear :level="2" :style='{
  "width": "100%"
}'  />
            </a-form-item>
          </a-col>
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_Address" :labelCol="{ style: { width: '100px' } }">
              <template #label>详情地址</template>
              <JnpfInput v-model:value="dataForm.F_Address" placeholder='请输入' allowClear :style='{
  "width": "100%"
}'  :showCount='false'  />
            </a-form-item>
          </a-col>
