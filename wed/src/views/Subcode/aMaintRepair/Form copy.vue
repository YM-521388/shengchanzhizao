<template>
  <BasicModal v-bind="$attrs" @register="registerModal" width="50%" :minHeight="100" okText="确定" cancelText="取消" @ok="handleSubmit" :closeFunc="onClose">
    <template #title>
      <a-space :size="10">
        ...
        <a-row :gutter="15">
          ...
          <a-col :span="24" class="ant-col-item" v-show="false">
            <a-form-item name="F_ReceiveTime" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfDatePicker
                v-model:value="dataForm.F_ReceiveTime"
                placeholder="请选择"
          ...
          <a-col :span="24" class="ant-col-item" v-show="false">
            <a-form-item name="F_HandleTime" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfDatePicker
                v-model:value="dataForm.F_HandleTime"
                placeholder="请选择"
                format="yyyy-MM-dd HH:mm:ss"
                allowClear
                :style="{
          ...
          <a-col :span="24" class="ant-col-item" v-show="false">
            <a-form-item name="F_PauseReason" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfTextarea
                v-model:value="dataForm.F_PauseReason"
                placeholder="请输入"
                :maxlength="500"
                allowClear
                :autoSize="{
          ...
          <a-col :span="24" class="ant-col-item" v-show="false">
            <a-form-item name="F_CancelReason" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfTextarea
                v-model:value="dataForm.F_CancelReason"
                placeholder="请输入"
                :maxlength="500"
                allowClear
                :autoSize="{
          ...
          <a-col :span="24" class="ant-col-item" v-show="false">
            <a-form-item name="F_AuditorUserId" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfUserSelect
                v-model:value="dataForm.F_AuditorUserId"
                placeholder="请选择"
                selectType="all"
                allowClear
                :style="{
          ...
          <a-col :span="24" class="ant-col-item" v-show="false">
            <a-form-item name="F_AuditTime" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfDatePicker
                v-model:value="dataForm.F_AuditTime"
                placeholder="请选择"
                format="yyyy-MM-dd HH:mm:ss"
                allowClear
                :style="{
          ...
          <a-col :span="24" class="ant-col-item" v-show="false">
            <a-form-item name="F_IsSolved" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfSelect
                v-model:value="dataForm.F_IsSolved"
                placeholder="请选择"
                :options="optionsObj.F_IsSolvedOptions"
                :fieldNames="optionsObj.F_IsSolvedProps"
                allowClear
                showSearch
                :style="{
                  width: '100%',
          ...
          <a-col :span="24" class="ant-col-item" v-show="false">
            <a-form-item name="F_HandleResult" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfTextarea
                v-model:value="dataForm.F_HandleResult"
                placeholder="请输入"
                :maxlength="500"
                allowClear
                :autoSize="{
          ...
          <a-col :span="24" class="ant-col-item" v-show="false">
            <a-form-item name="F_CreatorOrganizeId" :labelCol="{ style: { width: '100px' } }">
              <template #label>创建组织</template>
              <JnpfOpenData
                v-model:value="dataForm.F_CreatorOrganizeId"
                readonly
                type="currOrganize"
                showLevel="last"
                :style="{
...
<script lang="ts" setup>
  ...
  const state = reactive<State>({
    dataForm: {
      ...
      F_ReceiveTime: undefined,
      F_HandleTime: undefined,
      F_State: undefined,
      F_PauseReason: undefined,
      F_CancelReason: undefined,
      F_AuditorUserId: undefined,
      F_AuditTime: undefined,
      F_IsSolved: undefined,
      F_HandleResult: undefined,
      F_CreatorUserId: undefined,
      F_CreatorTime: undefined,
      F_CreatorOrganizeId: undefined,
    },
    dataRule: {
      F_DeviceId: [
        {
