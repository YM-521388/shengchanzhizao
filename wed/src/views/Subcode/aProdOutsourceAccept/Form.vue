  ...
  <BasicModal
    ...
    <a-row class="dynamic-form">
      <a-form :colon="false" layout="horizontal" labelAlign="right" :labelCol="{ style: { width: '100px' } }" :model="dataForm" :rules="dataRule" ref="formRef">
        <a-row :gutter="15">
          <a-col :span="24" class="ant-col-item" v-if="hasFormP('F_OutsourceId') && !state.dataForm.id">
          ...
          <a-col :span="24" class="ant-col-item" v-if="hasFormP('F_OutsourceId') && state.dataForm.id">
            <a-form-item name="F_OutsourceId" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfPopupSelect
                ...
                allowClear
                field="F_OutsourceId"
                interfaceId="2043618475414523904"
                :columnOptions="optionsObj.F_OutsourceIdOptions"
                relationField="F_OutsourceNo"
                propsValue="F_Id"
                :pageSize="20"
          ...
          <a-col :span="12" class="ant-col-item" v-if="hasFormP('F_PassNum')">
          ...
          <a-col :span="12" class="ant-col-item" v-if="hasFormP('F_FailNum')">
                ...
                <template #bodyCell="{ column, record, index }">
                  ...
                  <template v-if="column.key === 'F_AcceptId'">
                    <JnpfPopupSelect
                      ...
                      popupTitle="选择数据"
                      popupWidth="60%"
                      @change="(val, option) => acceptBtn(record, val, option)"
                      :style="{
                        width: '100%',
                      }"
...
<script lang="ts" setup>
  ...
  function acceptBtn(record, val, option) {
    for (var i = 0; i < state.dataForm.tableField561a64.length; i++) {
      if (state.dataForm.tableField561a64[i].jnpfId == record.jnpfId) {
        state.dataForm.tableField561a64[i].F_Content = option.F_Content;
      }
    }
  }
</script>
