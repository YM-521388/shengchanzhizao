        ...
        <a-row :gutter="15">
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_ProjectItemId" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfInput v-model:value="dataForm.F_ProjectItemId" :maskConfig='{
  "filler": "*",
  "maskType": 1,
  "prefixType": 1,
  "prefixLimit": 0,
  ...
  "unrealMaskLength": 1
          ...
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_GoodsId" :labelCol="{ style: { width: '100px' } }">
              ...
              <p>{{ dataForm.F_GoodsId }}</p>
            </a-form-item>
          </a-col>
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_Unit" :labelCol="{ style: { width: '100px' } }">
              <template #label>单位用量</template>
              <JnpfInputNumber v-model:value="dataForm.F_Unit" placeholder='请输入' :controls="false" :style='{
  "width": "100%"
}' disabled detailed />
            </a-form-item>
          </a-col>
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_ProdUnit" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfInputNumber v-model:value="dataForm.F_ProdUnit" placeholder='请输入' :controls="false" :style='{
  "width": "100%"
}' disabled detailed />
            </a-form-item>
          </a-col>
