      ...
      <a-form :colon="false" layout="horizontal" labelAlign="right" :labelCol="{ style: { width: '100px' } }" :model="dataForm" :rules="dataRule" ref="formRef">
        <a-row :gutter="15">
          <a-col :span="24" class="ant-col-item">
            <a-form-item name="F_ProjectItemId" :labelCol="{ style: { width: '100px' } }">
              <template #label>项目商品</template>
              <JnpfInput
                v-model:value="dataForm.F_ProjectItemId"
                placeholder="请输入"
                allowClear
                :style="{
                  width: '100%',
          ...
          <a-col :span="24" class="ant-col-item">
            <a-form-item name="F_GoodsId" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfSelect
                ...
                placeholder="请选择"
                :options="optionsObj.F_GoodsIdOptions"
                :fieldNames="optionsObj.F_GoodsIdProps"
                allowClear
                :style="{
                  width: '100%',
                }" />
          ...
          <a-col :span="24" class="ant-col-item">
            <a-form-item name="F_ProdUnit" :labelCol="{ style: { width: '100px' } }">
              <template #label>生产用量</template>
              <JnpfInputNumber
                v-model:value="dataForm.F_ProdUnit"
                placeholder="请输入"
                :min="1"
                :controls="false"
                :style="{
          ...
          <a-col :span="24" class="ant-col-item">
            <a-form-item name="F_StockInProcess" :labelCol="{ style: { width: '100px' } }">
              <template #label>入库工序</template>
              <JnpfSelect
                v-model:value="dataForm.F_StockInProcess"
                placeholder="请选择"
          ...
          <a-col :span="24" class="ant-col-item">
            <a-form-item name="F_FeedProcess" :labelCol="{ style: { width: '100px' } }">
              <template #label>投料工序</template>
              <JnpfSelect
                v-model:value="dataForm.F_FeedProcess"
                placeholder="请选择"
