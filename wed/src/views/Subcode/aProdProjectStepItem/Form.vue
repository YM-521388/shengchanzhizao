      ...
      <a-form :colon="false" layout="horizontal" labelAlign="right"  :labelCol="{ style: { width: '100px' } }" :model="dataForm" :rules="dataRule" ref="formRef">
        <a-row :gutter="15">
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_ProjectStepId" :labelCol="{ style: { width: '100px' } }">
              <template #label>项目商品工序</template>
              <JnpfSelect v-model:value="dataForm.F_ProjectStepId" placeholder='请选择' :options="optionsObj.F_ProjectStepIdOptions" :fieldNames="optionsObj.F_ProjectStepIdProps" allowClear showSearch :style='{
  "width": "100%"
}'  />
            </a-form-item>
          </a-col>
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_GoodsId" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfSelect v-model:value="dataForm.F_GoodsId" placeholder='请选择' :options="optionsObj.F_GoodsIdOptions" :fieldNames="optionsObj.F_GoodsIdProps" allowClear showSearch :style='{
  "width": "100%"
}'  />
            </a-form-item>
          </a-col>
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_Num" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfInputNumber v-model:value="dataForm.F_Num" placeholder='请输入' :min="1" :controls="false" :style='{
  "width": "100%"
}'  />
            </a-form-item>
          </a-col>
...
<script lang="ts" setup>
  ...
  const state = reactive<State>({
    ...
    optionsObj:{
      F_ProjectStepIdProps: {'label':'F_ProcessName','value':'id'},
  ...
  function getF_ProjectStepIdOptions() {
    let templateJson = []
    let query = {
    ...
    getDataInterfaceRes('2012092092830060544', query).then(res => {
      let data = res.data;
      state.optionsObj.F_ProjectStepIdOptions = Array.isArray(data) ? data : [];
    });
  }
