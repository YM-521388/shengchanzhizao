        ...
        <a-row :gutter="15">
          ...
          <a-col :span="24" class="ant-col-item">
            <a-form-item label="">
              ...
              <a-table
                :data-source="dataForm.tableField3ff267"
                :columns="tableField3ff267Columns"
                size="small"
                :pagination="false"
                :scroll="{ x: 'max-content' }">
                <template #headerCell="{ column }">
...
<script lang="ts" setup>
  ...
  const tableFieldf5c8efColumns: any[] = computed(() => {
    ...
    list = list.filter(o => hasFormP('Detail_QTCHD-' + o.formP));
    let columnList = list;
