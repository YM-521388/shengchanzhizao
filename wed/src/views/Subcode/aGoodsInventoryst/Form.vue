        ...
        <a-row :gutter="15">
          ...
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="F_WarehouseId" :labelCol="{ style: { width: '100px' } }">
              ...
              <JnpfCascader v-model:value="dataForm.F_WarehouseId" placeholder='请选择' :options="optionsObj.F_WarehouseIdOptions" :fieldNames="optionsObj.F_WarehouseIdProps" allowClear :style='{
  "width": "100%"
}'  />
            </a-form-item>
          </a-col>
