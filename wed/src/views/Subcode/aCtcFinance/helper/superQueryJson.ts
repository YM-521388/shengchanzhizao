const superQueryJson = [
  {
    ...
    "__config__": {
      ...
      "regList": [],
      "trigger": "blur",
      "formId": "formItemc44a89",
      "renderKey": 1768267334681
    },
    "on": {
  ...
  },
  {
    ...
    "__config__": {
      ...
      "regList": [],
      "trigger": "change",
      "formId": "formItem696a06",
      "renderKey": 1768267409695
    },
    "on": {
      "change": "({ data, rowIndex, formData, setFormData, setShowOrHide, setRequired, setDisabled, onlineUtils }) => {\n    // 在此编写代码\n    \n}"
    },
  ...
  },
  {
    ...
    "__config__": {
      ...
      "regList": [],
      "trigger": "blur",
      "formId": "formItem2d54e2",
      "renderKey": 1768267414962
    },
    "on": {
      "change": "({ data, rowIndex, formData, setFormData, setShowOrHide, setRequired, setDisabled, onlineUtils }) => {\n    // 在此编写代码\n    \n}",
      "blur": "({ data, rowIndex, formData, setFormData, setShowOrHide, setRequired, setDisabled, onlineUtils }) => {\n    // 在此编写代码\n    \n}"
  ...
  },
  {
    ...
    "__config__": {
      ...
      "regList": [],
      "trigger": "blur",
      "formId": "formItemcfbc25",
      "renderKey": 1768267425406
    },
    "on": {
      "change": "({ data, rowIndex, formData, setFormData, setShowOrHide, setRequired, setDisabled, onlineUtils }) => {\n    // 在此编写代码\n    \n}",
      "blur": "({ data, rowIndex, formData, setFormData, setShowOrHide, setRequired, setDisabled, onlineUtils }) => {\n    // 在此编写代码\n    \n}"
  ...
  },
  {
    ...
    "__config__": {
      ...
      "tableName": "a_ctc_finance",
      "noShow": false,
      "formId": "formItem592ab9",
      "renderKey": 1768267439911
    },
    "style": {
      "width": "100%"
    },
