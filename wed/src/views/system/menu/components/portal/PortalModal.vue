<template>
  <div class="common-container">
    ...
    <a-modal v-model:open="visible" title="选择门户" :width="800" class="jnpf-list-modal" @ok="handleSubmit" @cancel="handleCancel">
      <template #closeIcon>
...
<script lang="ts" setup>
  ...
  import { getPortalManageSelector } from '@/api/onlineDev/portal';
