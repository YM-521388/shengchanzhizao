  ...
  <div class="jnpf-content-wrapper">
    <div class="jnpf-content-wrapper-center">
      ...
      <div class="jnpf-content-wrapper-content bg-white">
        <a-tabs v-model:activeKey="activeKey" class="jnpf-content-wrapper-tabs tabs-contain" destroyInactiveTabPane>
...
<script lang="ts" setup>
  ...
  const [registerLoginTable, { reload: reloadLoginTable, getSelectRows: getLoginSelectRows, redoHeight }] = useTable(useTableAttrs);
