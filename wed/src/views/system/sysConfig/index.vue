  ...
  <div class="jnpf-content-wrapper">
    <div class="jnpf-content-wrapper-center bg-white">
      <a-form :colon="false" labelAlign="right" :labelCol="{ style: { width: '100px' } }" class="right-board-form h-full">
        <a-tabs class="jnpf-content-wrapper-tabs tabs-contain" v-model:activeKey="activeKey">
          <a-tab-pane :key="1" tab="基本设置" class="p-30px">
            <a-row>
              ...
              <!-- <a-col :span="12">
                <a-form-item label="员工端地址">
                  <a-input v-model:value="baseForm.employeeIp" placeholder="请输入" allowClear />
                </a-form-item>
              </a-col> -->
              <a-col :span="24">
          ...
          <a-tab-pane :key="5" tab="流程设置" class="p-30px">
            <a-row>
              <a-col :span="12">
                <JnpfGroupTitle class="mb-20px -mt-12px" content="基础配置" />
                <a-form-item :labelCol="{ style: { width: '120px' } }">
                ...
                <a-form-item :labelCol="{ style: { width: '120px' } }" v-if="baseForm.flowTodo">
          ...
          <a-tab-pane :key="6" tab="日程设置" class="p-30px">
            <a-row>
              <a-col :span="8">
                <a-form-item label="默认视图">
                  <jnpf-radio v-model:value="baseForm.defaultView" :options="defaultViewOptions" optionType="button" button-style="solid" />
                </a-form-item>
        ...
        update(state.baseForm)
          .then(res => {
            ...
            const sysConfigInfo = {
              ...
              employeeIp: state.baseForm.employeeIp,
