<template>
  ...
  <Modal v-model:open="visible" width="380px" :title="isEdit ? '编辑确认' : '删除确认'" centered destroyOnClose>
...
<script lang="ts" setup>
  ...
  import { getScheduleInfo, delSchedule, createSchedule, updateSchedule } from '@/api/workFlow/schedule';
  ...
  import {
    ...
    remindList,
    repeatReminderList,
  } from '@/components/FlowProcess/src/helper/define';
  ...
  function onDurationChange() {
    nextTick(() => {
      ...
      setFieldsValue({
        ...
        duration: state.dataForm.duration,
      });
    });
  }
