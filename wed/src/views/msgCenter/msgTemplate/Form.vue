            ...
            <div class="left-pane">
              <div class="left-pane-list">
                <div class="list">
                  ...
                  <BasicTable @register="registerTable" :data-source="parameterList" :scroll="tableScroll">
...
<script lang="ts" setup>
  ...
  const { dataForm, dataRule, messageTypeList, messageSourceList, title, keyword, parameterList, wxSkipList, smsList, isEdit, tableScroll } = toRefs(state);
  ...
  const flowParameterList = [
    ...
    { field: '@Mandator', fieldName: '委托人' },
    { field: '@Mandatary', fieldName: '被委托人' },
  ];
  ...
  function onMessageSourceChange(val) {
    ...
    state.allParameterList = state.parameterList;
    state.tableScroll = val == 4 ? { y: 314 } : { y: 294 };
  }
