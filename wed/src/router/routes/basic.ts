...
import { REDIRECT_NAME, LAYOUT, EXCEPTION_COMPONENT, PAGE_NOT_FOUND_NAME, CHILDREN_PAGE_NOT_FOUND_NAME } from '@/router/constant';
...
export const PAGE_NOT_FOUND_ROUTE: AppRouteRecordRaw = {
  ...
  children: [
    {
      path: '/:path(.*)*',
      name: CHILDREN_PAGE_NOT_FOUND_NAME,
