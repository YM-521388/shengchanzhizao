...
const ONLINE_REPORT = () => import('@/views/common/dynamicReport/index.vue');
const ONLINE_DATA_REPORT = () => import('@/views/common/dynamicDataReport/index.vue');
...
LayoutMap.set('ONLINE_DATA_REPORT', ONLINE_DATA_REPORT);
